<p align="center">
  <img src="public/logo.png" alt="SomaBridge Logo" width="120" height="120" style="border-radius: 24px;" />
</p>

<h1 align="center">SomaBridge</h1>
...
<p align="center">
  <em>Instead of asking "How do you feel?" — a question many cannot answer —<br/>SomaBridge asks "What does your body feel like?" and uses AI to bridge the gap.</em>
</p>
...
The body already knows. The vocabulary is missing. **SomaBridge bridges that gap.**
...
**SomaBridge is the first tool to start from the body, not the label.**

---

## How It Works

SomaBridge follows a clinically-informed, four-step flow that translates physical sensations into emotional vocabulary:
...
SomaBridge uses a **LangGraph JS StateGraph** — a directed graph with persistent state, not a simple prompt chain. The graph runs server-side in Next.js API routes.
...
The 3D body model is the centerpiece of SomaBridge — designed so that a neurodivergent teen looks at it and feels *"I can do this"*, not *"This is a medical exam."*
...
```bash
git clone https://github.com/Danger525/SomaBridge.git
cd somabridge
npm install
```
...
Open [http://localhost:3000](http://localhost:3000) — SomaBridge is ready.
...
**Uses SomaBridge to:** Generate Communication Cards to hand to teachers during overwhelm.
...
**Uses SomaBridge to:** Build a Personal Emotion Dictionary and bring body-pattern data to therapy sessions.
...
**Uses SomaBridge to:** Receive Communication Cards from Arjun that explain what he's feeling and what helps.
...
SomaBridge is built with a 4-layer fallback architecture to ensure it **never leaves a user stranded**:
...
SomaBridge is grounded in peer-reviewed clinical research:
...
**SomaBridge** is built for **IncludAI — The Neurodiversity Hackathon 2026**, Track 2: AI for Connection & Wellbeing.
...
> *"Every person deserves to understand their own inner world. SomaBridge gives neurodivergent youth a language for what they already feel — built from their own body's signals, not borrowed from someone else's vocabulary."*
