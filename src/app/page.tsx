  ...
  return (
    <main className={styles.main}>
      ...
      <section className={styles.heroSection}>
        ...
        >
          Your body speaks before you do. SomaBridge gently translates physical
      ...
      <section className={styles.objectiveSection}>
        ...
        <motion.p
          ...
          transition={getTransition(0.1)}
        >
          SomaBridge exists to give neurodivergent youth a pathway to emotional
      ...
      <section className={styles.solutionSection}>
        ...
        <motion.p
          ...
          transition={getTransition(0.1)}
        >
          SomaBridge combines an interactive 3D body map, a multi-model AI
      ...
      <section className={styles.audienceSection}>
        ...
        <motion.p
          ...
          transition={getTransition(0.1)}
        >
          SomaBridge serves neurodivergent youth and the people who care about them.
          ...
          {[
            ...
            >
              ...
              <p className={styles.personaUses}>
                <strong>Uses SomaBridge to:</strong> {persona.uses}
              </p>
            </motion.div>
          ))}
        </div>
